package com.admin.lee.slidechildview;
...
public class SlidelView extends FrameLayout {
    ...
    public SlidelView(Context context) {
        super(context);
    }

    public SlidelView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SlidelView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SlidelView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
